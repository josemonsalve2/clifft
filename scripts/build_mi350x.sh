...
# Cross-compile for gfx950 on mi300x node (has cmake + ROCm)
set -euo pipefail

BASE="/shared/jmonsalv/quantum/clifft_rl/clifft"
cd "$BASE"

echo "=== Cross-compiling for MI350X (gfx950) ==="
echo "Host: $(hostname)"
echo "Date: $(date)"
...
echo ""
ls -la run_gpu tests/clifft_tests 2>/dev/null
echo ""
echo "=== Build complete ==="
