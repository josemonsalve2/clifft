...
static clifft::CompiledModule compile_program(const std::string& path, bool postselect) {
    ...
    if (postselect) mask.assign(ref.detectors.size(), 1);
...
int main(int argc, char** argv) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        else if (a == "--postselection") postselect = true;
        else if (a == "--help" || a == "-h") {
